...
public class FileUtils {
	...
	//자유갤러리 첨부파일 
	public List<Map<String, Object>> parseInsertGBoardFileInfo(GBoardVO gboard, MultipartHttpServletRequest mpRequest)
			throws Exception {
